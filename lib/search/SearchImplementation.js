...
export default class Search {
    ...
    search(searchTerms, candidates) {
        return search(searchTerms, candidates);
    }

    toSearchCandidates(entries) {
        return toSearchCandidates(entries);
    }
};
 ...
 */
export function search(searchTerms, candidates) {
 ...
 */
export const toSearchCandidates = entries => entries.map(post => ({ post, text: extractText(post) }));
